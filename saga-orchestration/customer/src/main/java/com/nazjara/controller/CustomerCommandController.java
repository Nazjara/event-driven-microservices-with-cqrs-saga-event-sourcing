...
public class CustomerCommandController {
  ...
  public ResponseEntity<ResponseDto> updateMobileNumber(@RequestBody MobileNumberUpdateDto updateDto) {
    var command = UpdateCustomerMobileNumberCommand.builder()
        .customerId(updateDto.getCustomerId())
        .accountNumber(updateDto.getAccountNumber())
        .loanNumber(updateDto.getLoanNumber())
        .cardNumber(updateDto.getCardNumber())
        .currentMobileNumber(updateDto.getCurrentMobileNumber())
        .newMobileNumber(updateDto.getNewMobileNumber())
        .build();
