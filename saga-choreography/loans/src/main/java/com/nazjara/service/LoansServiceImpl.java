...
public class LoansServiceImpl implements ILoansService {
  ...
  public void createLoan(String mobileNumber) {
    var optionalLoan = loansRepository.findByMobileNumberAndActiveSw(mobileNumber,
  ...
  private Loans createNewLoan(String mobileNumber) {
    ...
    var randomLoanNumber = 1000000000L + new Random().nextInt(900000000);
  ...
  public LoansDto fetchLoan(String mobileNumber) {
    var loan = loansRepository.findByMobileNumberAndActiveSw(mobileNumber,
            LoansConstants.ACTIVE_SW)
  ...
  public boolean updateLoan(LoansDto loansDto) {
    var loan = loansRepository.findByMobileNumberAndActiveSw(loansDto.getMobileNumber(),
        LoansConstants.ACTIVE_SW).orElseThrow(
        () -> new ResourceNotFoundException("Loan", "LoanNumber",
            loansDto.getLoanNumber().toString()));
  ...
  public boolean deleteLoan(Long loanNumber) {
    var loan = loansRepository.findById(loanNumber)
        .orElseThrow(
  ...
  public void updateMobileNumber(MobileNumberUpdateDto mobileNumberUpdateDto) {
    ...
    var loan = loansRepository.findByMobileNumberAndActiveSw(mobileNumber, true)
        .orElseThrow(
