...
public class CustomerController {
  ...
  String mobileNumber) {
    var fetchedCustomer = iCustomerService.fetchCustomer(mobileNumber);
  ...
  public ResponseEntity<ResponseDto> updateCustomerDetails(
    ...
    var isUpdated = iCustomerService.updateCustomer(customerDto);
  ...
  @Pattern(regexp = "(^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$)",
    ...
    var isDeleted = iCustomerService.deleteCustomer(customerId);
  ...
  public ResponseEntity<ResponseDto> updateMobileNumber(
      @RequestBody @Valid MobileNumberUpdateDto mobileNumberUpdateDto) {
